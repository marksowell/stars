...
- [ricardojoserf/SAMDump](https://github.com/ricardojoserf/SAMDump) - Extract the SAM and SYSTEM hives using the Volume Shadow Copy (VSS) API. With exfiltration and XOR obfuscation options. Implemented in C#, C++, Crystal, Python, Rust, Golang, Nim and Deno (Javascript)
