...
- [S3N4T0R-0X0/BEAR-C2](https://github.com/S3N4T0R-0X0/BEAR-C2) - Bear C2 is a compilation of C2 scripts, payloads, and stagers used in simulated attacks by Russian APT groups, Bear features a variety of encryption methods, including AES, XOR, DES, TLS, RC4, RSA and
- [ricardojoserf/SAMDump](https://github.com/ricardojoserf/SAMDump) - Extract the SAM and SYSTEM hives using the Volume Shadow Copy (VSS) API. With exfiltration and XOR obfuscation options. Implemented in C#, C++, Crystal and Python
